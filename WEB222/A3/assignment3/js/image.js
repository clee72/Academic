...
window.onload = function () {
    var imgs = document.querySelector("#nature_images");
    var imgs2 = "";

    for (var i = 0; i < images.length; i++) {
        imgs2 += '<figure><img src="' + images[i].url + '" alt = "' + images[i].alt + '">';
        imgs2 += '<figcaption>' + images[i].caption + "</figcation></figure>";
    }


    imgs.innerHTML = imgs2;
};